...
module.exports = function (RED) {
    ...
    function GetAssetCategories(options) {
        ...
        node.on('input', function (msg) {
            ...
            const option = {
                url: 'https://api.networkale.com/api/v1/sites/'+this.context().flow.get("OAS_siteID")+"/assetcategories",
            ...
            request( option, function(error, response, body) {
                ...
                /*msg.payload = {body:body,
                               ...
                               error:error};*/
                //console.log(msg);
                msg.topic = "Informations about the asset categories."
    ...
    RED.nodes.registerType("get_assetcategories",GetAssetCategories);
}

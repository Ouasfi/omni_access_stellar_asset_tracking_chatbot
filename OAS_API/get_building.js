...
module.exports = function (RED) {
    ...
    function GetBuilding(options) {
        ...
        node.on('input', function (msg) {
            ...
            const option = {
                url: 'https://api.networkale.com/api/v1/sites/'+this.context().flow.get("OAS_siteID")+"/buildings/"+msg.buildingID,
            ...
            request( option, function(error, response, body) {
                ...
                /*msg.payload = {body:body,
                               ...
                               error:error};*/
                //console.log(msg);
                msg.topic = "Caracteristics of a building."
    ...
    RED.nodes.registerType("get_building",GetBuilding);
}
